...
struct A31InteractiveRenderTrace
{
	...
	bool text_display_available;
	bool text_display_render_called;
	...
	bool action_active;
	bool action_busy;
	bool control_action_active;
	bool control_reload_active;
	bool input_action_active;
	bool input_reload_active;
	bool input_use_weapon_active;
	...
	bool input_dpad_right_down;
	uint32_t input_action_key_state;
	uint32_t input_reload_key_state;
