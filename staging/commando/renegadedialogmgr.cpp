...
{
	// Preserve the original factory mechanism for the first playable route.
	// Online/LAN and option pages whose real services are not linked yet stay
	// unavailable instead of being replaced by synthetic dialogs.
