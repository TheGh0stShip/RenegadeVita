...
bool Write_State(const char *path, const A31StateSnapshot &state)
{
	...
	fprintf(file, "\n  \"loading_visual_gate\":{\"active\":%s,\"framebuffer_width\":%u,\"framebuffer_height\":%u,\"original_logical_width\":%u,\"original_logical_height\":%u,\"native_display_width\":%u,\"native_display_height\":%u,\"logical_to_native_fullscreen\":%s,\"original_loading_screen_owner\":%s,\"direct_vitagl_overlay_disabled\":%s,\"loading_texture_v_flip_enabled\":%s,\"gameplay_texture_v_unchanged\":%s},",
