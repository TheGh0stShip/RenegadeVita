	...
	while (cload.Open_Chunk()) {
		...
		if (cload.Cur_Chunk_ID() == PSCENE_SO_CHUNK_STATIC_OBJECT) {
			...
			*/ 
			...
			A35_Vita_Static_Load_Trace_Begin(object_index, factory_id);
#endif
...
#if defined(__vita__)
			A35_Vita_Static_Load_Trace_End();
