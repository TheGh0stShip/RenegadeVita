...
{
	uintptr_t pointer_sum = reinterpret_cast<uintptr_t>(key.Model) +
		reinterpret_cast<uintptr_t>(key.UserLighting);
	unsigned int hval = static_cast<unsigned int>(pointer_sum);
