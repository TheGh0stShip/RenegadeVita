...
| A3.5-dev5 integrity gate | candidate-specific startup label/log, verified nonempty static and interactive capture bundles, corrected overlay, orderly-exit bundle | coherent fresh ARM/VPK candidate built; physical gate remains closed |
