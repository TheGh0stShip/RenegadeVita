...
PATHS = {
    ...
    "visual_gate": [
        ...
        "loading_visual_gate.native_presentation_x",
        "loading_visual_gate.native_presentation_y",
        "loading_visual_gate.native_presentation_width",
        "loading_visual_gate.native_presentation_height",
        "loading_visual_gate.logical_to_native_fullscreen",
        "loading_visual_gate.aspect_preserved",
