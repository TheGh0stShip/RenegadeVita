...
grep -Fq '"patch_count": 133' "$rv_root/reports/SOURCE_INTEGRATION_REPORT.json"
...

{
	...
	echo "Patch set: deterministic zero-fuzz staging patches; patch_count=133; pristine upstream=PASS"
