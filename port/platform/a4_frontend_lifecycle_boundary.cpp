...
void DX8RendererDebugger::Update(void) {}
void cDiagnostics::Render(void) {}

#if defined(RENEGADE_HOST_ABI_TEST)
void WWAudioClass::Temp_Disable_Audio(bool)
{
}
#endif
...
// The first Vita campaign path is single-player only. These multiplayer
// dialog/event constructors are referenced by original CombatGameMode branches
// that stay fail-closed until the networking provider reaches an evidence gate.
CNCServerInfoDialogClass::CNCServerInfoDialogClass()
	: MenuDialogClass(IDD_CNC_SERVER_INFO)
{
}

CNCServerInfoDialogClass::~CNCServerInfoDialogClass() = default;
void CNCServerInfoDialogClass::On_Init_Dialog() { End_Dialog(); }
void CNCServerInfoDialogClass::On_Frame_Update() {}

CNCTeamInfoDialogClass::CNCTeamInfoDialogClass()
	: MenuDialogClass(IDD_CNC_TEAM_INFO)
{
}

CNCTeamInfoDialogClass::~CNCTeamInfoDialogClass() = default;
void CNCTeamInfoDialogClass::On_Init_Dialog() { End_Dialog(); }
void CNCTeamInfoDialogClass::On_Frame_Update() {}

CNCBattleInfoDialogClass::CNCBattleInfoDialogClass()
	: MenuDialogClass(IDD_CNC_BATTLE_INFO)
{
}

CNCBattleInfoDialogClass::~CNCBattleInfoDialogClass() = default;
void CNCBattleInfoDialogClass::On_Init_Dialog() { End_Dialog(); }
void CNCBattleInfoDialogClass::On_Frame_Update() {}

MPIngameChatPopupClass::MPIngameChatPopupClass()
...
MPIngameChatPopupClass::~MPIngameChatPopupClass() = default;
void MPIngameChatPopupClass::On_Init_Dialog() { End_Dialog(); }
void MPIngameChatPopupClass::On_Command(int, int, DWORD) { End_Dialog(); }
void MPIngameChatPopupClass::Render() {}
...
CSAnnouncement::~CSAnnouncement() = default;

void CSAnnouncement::Init(int to_id, int announcementID,
	AnnouncementEnum type, int radio_cmd_id)
{
	mToID = to_id;
