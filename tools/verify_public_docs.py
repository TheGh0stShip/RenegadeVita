...
REQUIRED_TEXT = {
    "README.md": ("A3.1.4", "A3.5-dev91", "not a public game release"),
    "docs/CURRENT_STATUS.md": ("A3.5-dev87", "A3.5-dev90", "Local-only"),
    ...
    "docs/HISTORICAL_CAPTURE_CAMPAIGN.md": ("dev1 through dev91", "post-render M00 PNG", "READY"),
}
