...
// DirectInput 8 keyboard scan-code surface used by the original Combat input
// action database.  These values remain the canonical logical key identities;
// the Vita controller adapter maps sceCtrl state beneath DirectInputClass.
