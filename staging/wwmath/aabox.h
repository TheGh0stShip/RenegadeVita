...
// These overloads are declared by colmath.h but defined inline only after an
// AABoxClass is complete.  VC6 obtained them transitively; make that contract
// explicit without including the header during colmath.h's forward declarations.
